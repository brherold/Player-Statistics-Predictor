from RecruitSkillPredictorCol.scripts.functions_4 import *
...
def getPredictedSkills(playerID,predYear):
    ...
    save_path = os.path.join(folder, f'{playerID}-{predYear}-playerSkils-2047.pkl')
...
#print(getPredictedSkills(235368,5))