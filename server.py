...
def submit():
    ...
    data = json.loads(data) #Parse json -> dictionary


    '''
    # Dummy Data
    data = {'Position':'PF','IS': 14, 'IQ': 11, 'OS': 13, 'Pass': 3, 'Rng': 14, 'Hnd': 14, 'Fin': 11, 'Drv': 11, 'Reb': 15, 
    'Str': 13, 'IDef': 16, 'Spd': 9, 'PDef': 9, 'Sta': 12, 'Weight': 215.0, 'Wingspan_inches': 90.0, 
    'Height_inches': 82.0, 'Vertical_float': 33.5, 'height': 82.0, 'wingspan': 90.0, 'weight': 215.0, 
    'vertical': 33.5}
    '''
